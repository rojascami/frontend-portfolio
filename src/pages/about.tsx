        ...
        <div className="bg-white flex flex-col justify-center">
            ...
            <div className="flex flex-row justify-end gap-3 mr-5 ">
             ...
             <div className="relative w-44 flex justify-evenly items-center self-center mt-10">
                ...
                <Link className="p-2 self-center  text-sm inset-0 relative flex items-center justify-center font-medium" href="/projects">

                    <div className="bg-violet-400  absolute  w-40 h-20 rounded-full blur-xl opacity-35 transition-colors duration-300 hover:bg-violet-700" />Go to projects</Link>
            </div>
        </div>
    )
}
